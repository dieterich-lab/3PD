 ...
 *
 */
public class EnhancedSuffixArrayFatOpt extends primerDesign.dsc.indexStructures.esa.EnhancedSuffixArray{
	/**
	 * 
	 */
	...
	public void createIndex(){
		...
		//computeLCPTable();
		{
			this.lcptab = LinearTimeLCP.getLCP(this.sequence, this.suftab);
		}
		if(printStatus){
	...
	public static void main(String[] args) throws IOException{		
		...
		if(mode.equals("create")){
			EnhancedSuffixArrayFatOpt testIndex;
				...
				{					
					System.out.println("Creating EnhancedSuffixArray for all sequences in file " + file);
					
					System.out.print("Reading in sequence");
					...
					//sequence = "ACAAACATAT";
					testIndex = new EnhancedSuffixArrayFatOpt(buffy.toString().toCharArray(), file);
				}
				//System.gc();
