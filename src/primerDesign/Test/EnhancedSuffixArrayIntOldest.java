 ...
 *
 */
public class EnhancedSuffixArrayIntOldest implements DNASequenceIndex, Serializable{
	/**
	 * 
	 */
	...
	public EnhancedSuffixArrayIntOldest(String sequence){
...
private int compareSuffix(int a, int b){
	...
	public static void main(String[] args) throws IOException{		
		...
		EnhancedSuffixArrayIntOldest testIndex;
		...
		for(int i=0; i<sequences.length; i++){
			System.out.println("Reading sequence " + sequences[i]);
			{
				...
				//sequence = "ACAAACATAT";
				testIndex = new EnhancedSuffixArrayIntOldest(sequence);
